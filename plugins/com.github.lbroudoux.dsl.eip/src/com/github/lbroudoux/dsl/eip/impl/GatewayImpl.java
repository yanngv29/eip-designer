 ...
 * @generated
 */
public class GatewayImpl extends CDOObjectImpl implements Gateway {
	/**
	...
	public String getName() {
		return (String)eDynamicGet(EipPackage.GATEWAY__NAME, EipPackage.Literals.ENDPOINT__NAME, true, true);
	}
	...
	public void setName(String newName) {
		eDynamicSet(EipPackage.GATEWAY__NAME, EipPackage.Literals.ENDPOINT__NAME, newName);
	}
	...
	public Channel getToChannel() {
		return (Channel)eDynamicGet(EipPackage.GATEWAY__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, true, true);
	}
	...
	public Channel basicGetToChannel() {
		return (Channel)eDynamicGet(EipPackage.GATEWAY__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, false, true);
	}
	...
	public NotificationChain basicSetToChannel(Channel newToChannel, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newToChannel, EipPackage.GATEWAY__TO_CHANNEL, msgs);
		return msgs;
	}
	...
	public void setToChannel(Channel newToChannel) {
		eDynamicSet(EipPackage.GATEWAY__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, newToChannel);
	}
	...
	public EList<Channel> getFromChannels() {
		return (EList<Channel>)eDynamicGet(EipPackage.GATEWAY__FROM_CHANNELS, EipPackage.Literals.ENDPOINT__FROM_CHANNELS, true, true);
	}
