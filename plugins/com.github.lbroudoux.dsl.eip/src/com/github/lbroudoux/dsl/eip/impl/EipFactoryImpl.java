...
public class EipFactoryImpl extends EFactoryImpl implements EipFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case EipPackage.CHANNEL: return (EObject)createChannel();
			case EipPackage.ADAPTER: return (EObject)createAdapter();
			case EipPackage.ROUTER: return (EObject)createRouter();
			case EipPackage.FILTER: return (EObject)createFilter();
			case EipPackage.TRANSFORMER: return (EObject)createTransformer();
			case EipPackage.GATEWAY: return (EObject)createGateway();
			case EipPackage.CONDITIONAL_ROUTE: return (EObject)createConditionalRoute();
			case EipPackage.SPLITTER: return (EObject)createSplitter();
			case EipPackage.AGGREGATOR: return (EObject)createAggregator();
			case EipPackage.ROUTE: return (EObject)createRoute();
			case EipPackage.SERVICE_ACTIVATOR: return (EObject)createServiceActivator();
			case EipPackage.EIP_MODEL: return (EObject)createEIPModel();
			case EipPackage.ENRICHER: return (EObject)createEnricher();
			case EipPackage.COMPOSITE_PROCESSOR: return (EObject)createCompositeProcessor();
			case EipPackage.RECIPIENT_LIST_ROUTER: return (EObject)createRecipientListRouter();
			case EipPackage.SERVICE_REF: return (EObject)createServiceRef();
			case EipPackage.SERVICE_INVOCATION: return (EObject)createServiceInvocation();
			case EipPackage.INVOCABLE_ENDPOINT: return (EObject)createInvocableEndpoint();
			case EipPackage.CONTENT_FILTER: return (EObject)createContentFilter();
			case EipPackage.RESEQUENCER: return (EObject)createResequencer();
			default:
