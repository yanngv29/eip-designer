 ...
 * @generated
 */
public class SplitterImpl extends CDOObjectImpl implements Splitter {
	/**
	...
	public String getName() {
		return (String)eDynamicGet(EipPackage.SPLITTER__NAME, EipPackage.Literals.ENDPOINT__NAME, true, true);
	}
	...
	public void setName(String newName) {
		eDynamicSet(EipPackage.SPLITTER__NAME, EipPackage.Literals.ENDPOINT__NAME, newName);
	}
	...
	public Channel getToChannel() {
		return (Channel)eDynamicGet(EipPackage.SPLITTER__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, true, true);
	}
	...
	public Channel basicGetToChannel() {
		return (Channel)eDynamicGet(EipPackage.SPLITTER__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, false, true);
	}
	...
	public NotificationChain basicSetToChannel(Channel newToChannel, NotificationChain msgs) {
		msgs = eDynamicInverseAdd((InternalEObject)newToChannel, EipPackage.SPLITTER__TO_CHANNEL, msgs);
		return msgs;
	}
	...
	public void setToChannel(Channel newToChannel) {
		eDynamicSet(EipPackage.SPLITTER__TO_CHANNEL, EipPackage.Literals.ENDPOINT__TO_CHANNEL, newToChannel);
	}
	...
	public EList<Channel> getFromChannels() {
		return (EList<Channel>)eDynamicGet(EipPackage.SPLITTER__FROM_CHANNELS, EipPackage.Literals.ENDPOINT__FROM_CHANNELS, true, true);
	}
